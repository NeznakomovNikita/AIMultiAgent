...
async def test_jira_create_epic(
    ...
    This test verifies that thejira_create_issue method can handle Epic creation
...
async def test_jira_create_epic_two_step(
    ...
    This test verifies that thejira_create_issue method can successfully create an Epic

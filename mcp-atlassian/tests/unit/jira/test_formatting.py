...
def test_create_issue_metadata_basic(formatting_mixin):
    """Testjira_create_issue_metadata method with basic inputs."""
    issue_key = "TEST-123"
    issue = {
        "fields": {
            "summary": "Test issue",
...
def test_create_issue_metadata_with_assignee_and_reporter(formatting_mixin):
    """Testjira_create_issue_metadata method with assignee and reporter."""
    issue_key = "TEST-123"
    issue = {
        "fields": {
            "summary": "Test issue",
...
def test_create_issue_metadata_with_priority(formatting_mixin):
    """Testjira_create_issue_metadata method with priority."""
    issue_key = "TEST-123"
    issue = {
        "fields": {
            "summary": "Test issue",
...
def test_create_issue_metadata_with_epic(formatting_mixin):
    """Testjira_create_issue_metadata method with epic information."""
    issue_key = "TEST-123"
    issue = {
        "fields": {
            "summary": "Test issue",

...
class TestIssuesMixin:
    ...
    def test_create_issue_basic(self, issues_mixin: IssuesMixin):
        ...
        # Mockjira_create_issue response
    ...
    def test_create_issue_no_components(self, issues_mixin: IssuesMixin):
        ...
        # Calljira_create_issue with components=None
        issue = issues_mixin.create_issue(
            project_key="TEST",
            summary="Test Issue",
            issue_type="Bug",
    ...
    def test_create_issue_single_component(self, issues_mixin: IssuesMixin):
        ...
        # Calljira_create_issue with a single component
        issue = issues_mixin.create_issue(
            project_key="TEST",
            summary="Test Issue",
            issue_type="Bug",
    ...
    def test_create_issue_multiple_components(self, issues_mixin: IssuesMixin):
        ...
        # Calljira_create_issue with multiple components
        issue = issues_mixin.create_issue(
            project_key="TEST",
            summary="Test Issue",
            issue_type="Bug",
    ...
    def test_create_issue_components_with_invalid_entries(
        ...
        # Calljira_create_issue with components list containing invalid entries
        issue = issues_mixin.create_issue(
            project_key="TEST",
            summary="Test Issue",
            issue_type="Bug",
    ...
    def test_create_issue_components_precedence(self, issues_mixin, caplog):
        ...
        # This simulates what happens insidejira_create_issue
    ...
    def test_create_epic(self, issues_mixin: IssuesMixin):
        ...
        with patch(
            ...
            with patch.object(
                ...
                # Verifyjira_create_issue was called with the right project and summary
    ...
    def test_create_issue_with_parent_for_task(self, issues_mixin: IssuesMixin):
        ...
        # Setup mock response forjira_create_issue
        create_response = {
            "id": "12345",
            "key": "TEST-456",
